...
const projects = [
  {
    title: "Dailymatch.in",
    description:
      "Built a responsive gaming website for a client using HTML, CSS, JavaScript, and React, showcasing strong front-end development and interactive UI design skills. ",
