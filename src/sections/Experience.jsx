...
const experiences = [
  ...
  //   },
  {
    period: "May 2026 — At present",
    role: "Full Stack Developer",
    company: "Alaukik ITech Solution.",
    description:
              ...
              >
                ...
                >
                  <TiltCard
                    maxTilt={12}
                    scale={1.03}
                    className="group glass p-6 rounded-2xl border border-primary/30 hover:border-primary/50 cursor-pointer"
                  >
